...
import { subregion } from "@/data/mock-data";
...
const SubRegion = ({ params }: { params: string }) => {
  ...
  const needsExplorerUrl = new URL(
    "/needs-assessments/explorer/",
    getBaseURL()
  );
    ...
    <SimpleLayout>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-col">
          ...
          {subregion?.newsUpdates?.length > 0 && (
            <div
              className="last:grow"
              style={{ backgroundColor: getBackgroundColor() }}
            >
