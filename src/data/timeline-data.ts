...
export const data = [
  ...
  },
  {
    ...
    bgColor: colors.blue,
    imageSrc: "/images/about-us/21-Fall-AfghanSafeHaven.png",
    imgAlt: "A person is showing a pink dress to a child. Behind them, lots of clothes are laid out on a row of tables.",
  },
  {
    period: "Winter 2021",
  ...
  },
  {
    ...
    bgColor: colors.green,
    imageSrc: "/images/about-us/22-Fall-UkraineResponse.jpeg",
    imgAlt: "A group of smiling people in warm winter clothing posing for a photo in a warehouse. One of them is holding up a light green heart-shaped stuffy or small pillow. Behind the group, we see lots of boxes and pallets filled with donations.",
  },
  {
    anchor: "2023",
    period: "Spring 2023",
  ...
  },
  {
    ...
    imgAlt: "Women and children in Gaza are congregating around a man with a clipboard next to a sign by Distribute Aid partner organisation Anera which reads “Medical Healthcare. Free Health Day. Gaza Strip”. Photo by Anera.",
  ...
  },
  {
    ...
    bgColor: colors.blue,
    imageSrc: "/images/about-us/24-Sep-HurricaneHelene1.jpeg",
    imgAlt: "Two team members of the Gulf Disaster Network posing happily at the back of a truck that is already half filled with boxes full of aid supplies.",
  },
  {
    anchor: "2025",
    period: "January 2025",
    ...
    imgAlt: "Group photo of the Community Solidarity Project team in LA in front of a 99c only store. They’re holding up a banner that says, “thank you, Distribute Aid”.",
  },
  {
    period: "Summer 2025",
    ...
    bgColor: colors.green,
    imageSrc: "/images/about-us/25-Summer-HrtHarmReductionKit.jpg",
    imgAlt: "A hand wearing medical gloves is slipping one of our HRT zines into a clear plastic bag holding various medical supplies. The zine reads “All we have is each other. All we have is now.” and is decorated with illustrations of flowers in pink and blue. More zines are piled up in the background.",
  },
];
