...
export const techContent = [
  {
    ...
    links: [
      {
        linkText: "Apply for Open Source Explorers",
        text: " - Applications will be open through November 2023.",
        href: "/",
      },
      {
        linkText: "explorers@distributeaid.org",
        textStart: "Email",
        text: " to volunteer as a mentor, inquire about corporate sponsorship, or ask questions and connect with the team.",
        href: "mailto:explorers@distributeaid.org",
      },
    ],
  },
  {
    ...
    description: [
      ...
      {
        textStart:
          "If you don’t see yourself and your skills represented here, please ",
        text: " and let us know to see if it makes sense for you to apply for the first cohort.",
    ...
    specificProjects: [
      ...
      {
        linkText: "Data Exporer",
        textStart: "Visualisations like our ",
        href: "/needs-assessments/explorer/",
      },
    ...
    applicationProcess: [
      {
        ...
        textStart: "Step 1: Fill out our ",
        text: " The deadline is end of November 2023..",
        href: "/",
      },
      {
        textStart: "Step 2: Interview",
        text: " This is a chance for us to get to know each other, figure out how much time you can commit to the program, and work out which contributor track or project you’d be the best fit. These will happen in November and December.",
      },
      {
        textStart: "Step 3: Final decision and onboarding",
        text: " If you’re invited to join the the Open Source Explorers program, we’ll introduce you to your mentor and start onboarding you. We’ll make our final decision and inform participants by mid-December.",
      },
      {
        textStart: "Step 4: Open Source Explorers program ",
        text: " The program kicks off in week 2 of January and runs until mid-March",
      },
    ],
    applyLink: "/",
    getInTouch: {
      linkText: "Kai Katschthaler. ",
      textStart: "Any questions? Get in touch with our Program Lead",
      href: "mailto:explorers@distributeaid.org",
    },
  },
  {
    ...
    getInTouch: {
      linkText: " please get in touch with Taylor ",
      textStart: "If you are interested in becoming a mentor or sponsor, ",
      href: "mailto:taylor@distributeaid.org",
    },
  },
];
