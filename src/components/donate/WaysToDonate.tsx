...
export const WaysToDonate = () => {
    ...
    return (
      ...
      ------------------------------------------------------------ */}
            ...
            >
                <Image className="h-9" src='/images/paypal-color.svg' alt="PayPal Logo"  width={200} height={200}/>
                <Divider />
      ...
      ------------------------------------------------------------ */}
            ...
            >
                <Image src='/images/direct_transfer.svg' className="h-9 w-9" alt="Dollar sign" width={200} height={200} />
                <Divider />
