      ...
      <Flex 
       ...
       >
        ...
        <Flex 
          ...
          <Heading 
          className="text-lg lg:text-5xl md:text-4xl sm:text-3xl md:mt-10 mt-4 font-bold drop-shadow-[0px_4px_6px_rgba(5,30,93,0.7)]">
            Open-Source Solutions For Global Aid Delivery
          </Heading>
          <Text 
          className="text-sm md:text-lg sm:text-md font-roboto font-bold md:mx-32 md:mt-6 p-4 text-center drop-shadow-[0px_4px_6px_rgba(5,30,93,0.6)]">
            ...
            is open-sourced.  </Text>

         <Text 
         className="text-sm md:text-lg sm:text-md font-roboto font-bold md:mx-32 p-4 text-center drop-shadow-[0px_4px_6px_rgba(5,30,93,0.6)]">
          ...
          className="w-full ">
            ...
            <Button 
            className="w-[160px] h-[60px] px-4 py-2 text-sm font-normal">
              Join Our Team
            </Button>
            <Button 
            className="w-[160px] h-[60px] text-sm  bg-white text-blue-950 font-normal">
              Become a Sponsor
            </Button>
          </Flex>
        </Flex>
