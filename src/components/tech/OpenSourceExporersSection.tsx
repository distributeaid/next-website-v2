        ...
        <Container size={{ xs: "1", sm: "2", md: "3", lg: "4"}} align="center">
            <Flex width="100%" direction="column" align="center" justify="center">
                ...
                >
                    ...
                    >Open Source Explorers</Heading>
                </Box>
                <Flex
                    width="100%" direction="column" gap="4" justify="center" align="center" 
                >
                    <Text
                        size={{ initial: "2", sm: "3"}}
                        align="center"
                    ...
                    <Text
                        ...
                        className="text-navy-900"
                        >
                        Find out more about Open Source Explorers, including when we’re running our next cohort!</Text>
                    <Link >
                        <Button
                            size="4"
                            >
