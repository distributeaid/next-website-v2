import { Box, Button, Heading, Text, TextField, Flex } from "@radix-ui/themes";
  ...
  return (
    <>
      <Box>
        ...
        <Text>Three Ways To Make A Difference</Text>
        <Flex
          style={{
      ...
      >
        <Box>
          <Heading as="h3">Stay Connected With Distribute Aid</Heading>
          <Text>
          ...
          <Flex gap="2">
            <TextField.Root size="3" placeholder="Enter email address" />
            <Button size="3">Subscribe Now</Button>
          </Flex>
        </Box>
      </Box>
    </>
